...
const char * VERSION_NUMBER = "v1.6";
...
int pulse(RehamoveDevice * r, Smpt_Channel channel, float current, int pulse_width) {
    if (r == NULL) {
...
int custom_pulse(RehamoveDevice * r, Smpt_Channel channel, int num_points, float c0, int w0, float c1, int w1, float c2, int w2, float c3, int w3, float c4, int w4, float c5, int w5, float c6, int w6, float c7, int w7, float c8, int w8, float c9, int w9, float c10, int w10, float c11, int w11, float c12, int w12, float c13, int w13, float c14, int w14, float c15, int w15) {
    ...
    /* Set the data */
    ll_channel_config.enable_stimulation = true;
    ll_channel_config.channel = Smpt_Channel::Smpt_Channel_Blue;
